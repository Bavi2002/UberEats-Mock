      ...
      {isLoading ? (
        ...
        >
          {[...Array(6)].map((_, index) => (
            ...
            >
              <div className="h-56 w-full bg-gradient-to-r from-gray-100 to-gray-200 rounded-md mb-4 animate-pulse"></div>
              <div className="h-6 bg-gradient-to-r from-gray-100 to-gray-200 rounded w-3/4 mb-2 animate-pulse"></div>
              <div className="h-4 bg-gradient-to-r from-gray-100 to-gray-200 rounded w-1/2 mb-2 animate-pulse"></div>
              <div className="h-4 bg-gradient-to-r from-gray-100 to-gray-200 rounded w-2/3 animate-pulse"></div>
            </div>
          ))}
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mt-6">
          {restaurants.map((restaurant) => (
            <Link
              ...
              className="bg-white border border-gray-100 p-4 rounded-lg shadow-sm   transition-all duration-200"
